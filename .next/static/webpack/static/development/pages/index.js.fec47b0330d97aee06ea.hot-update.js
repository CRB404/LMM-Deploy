...
function Footer() {
  return __jsx("footer", {
    ...
    className: "pt-28 pb-8 flex flex-col items-center",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
  ...
  }, "Last Mile Money is a program of IDEO CoLab in partnership with the Bill & Melinda Gates Foundation. We work closely with IDEO.org, including its Women + Money program.")), __jsx("div", {
    ...
    className: "legal px-2 py-2 m-2 pl-0 flex-grow text-left",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22,
  ...
  }, "PRIVACY & COOKIES POLICY"), "\\", __jsx("hr", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
    ...
    className: "legal px-2 py-2 m-2 flex-grow text-right",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
...
//# sourceMappingURL=index.js.fec47b0330d97aee06ea.hot-update.js.map